import { DOM, TaskQueue, bindingMode, ElementEvents, PLATFORM } from 'aurelia-framework';
import { bindable, observable } from 'aurelia-typed-observable-plugin';
import dragula from 'dragula';
import { configure } from 'aurelia-blur-attribute';
import { configure as configure$1 } from 'aurelia-portal-attribute';
...
function configure$2(fxconfig) {
    fxconfig.plugin(configure$1);
    fxconfig.plugin(configure);
    DOM.injectStyles(css, undefined, undefined, 'crud-filter-css');
    fxconfig.globalResources(CrudFilter);
}

export { CrudFilter, configure$2 as configure };
